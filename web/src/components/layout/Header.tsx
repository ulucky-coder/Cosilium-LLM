...
import { AGENTS, SHORTCUTS } from "@/lib/constants";
    ...
    <header className="h-12 border-b border-slate-800 bg-slate-950/80 backdrop-blur-sm flex items-center px-4 gap-4 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white text-sm">LLM-top</span>
        </div>
      </div>
      ...
      <button
        ...
        className="flex-1 max-w-xl mx-auto h-8 px-3 rounded-lg bg-slate-900 border border-slate-700 flex items-center gap-2 text-slate-400 text-sm hover:border-slate-600 hover:text-slate-300 transition-colors"
      >
        <Search className="h-4 w-4" />
        <span className="flex-1 text-left">Search, create, navigate...</span>
